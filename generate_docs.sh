...
if [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_BRANCH" == "master" ]; then
    ...
    jazzy --objc --clean --umbrella-header ../NSMutableNumber.h --framework-root . --module-version 1.2.3 --author "Oleh Kulykov" --author_url http://www.resident.name --github_url https://github.com/belisoful/NSMutableNumber --module NSMutableNumber --root-url http://belisoful.github.io/NSMutableNumber --theme apple --min-acl public --readme ../README.md
